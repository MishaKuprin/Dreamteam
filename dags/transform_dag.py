...
@task()
def first_datamart_transform():
    costed_event = pd.read_csv(f"{DATA_PATH}/costed_event0.csv", index_col=False)
    customer = pd.read_csv(f"{DATA_PATH}/customer.csv", index_col=False).head(500)
    product_instance = pd.read_csv(f"{DATA_PATH}/product_instance.csv", index_col=False)
    product = pd.read_csv(f"{DATA_PATH}/product.csv", index_col=False)
    payment = pd.read_csv(f"{DATA_PATH}/payment0.csv", index_col=False)
